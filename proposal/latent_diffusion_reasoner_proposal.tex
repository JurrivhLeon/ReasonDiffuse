...
Start with teacher-forced flow matching, then enable rollout training:
\begin{enumerate}[itemsep=0pt]
    \item Warm up with pointwise \(\mathcal L_{\mathrm{FM}}\), answer loss from one-step denoising, and Q-head supervision.
